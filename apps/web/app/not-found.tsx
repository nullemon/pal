...
export default async function NotFound() {
  ...
  return (
    <ToastProvider>
      {/* No header, main, footer or bottom nav here: Next renders this inside the site
          layout, which already provides all four. Rendering them again gave every broken
          link two stacked navbars, two footers and two `<main>` landmarks — the axe rules
          that would have caught it (`landmark-unique`, `landmark-one-main`) are
          best-practice, which the accessibility suite deliberately excludes. */}
