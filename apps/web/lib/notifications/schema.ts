...
// The modes themselves live in `./follow-modes`, which imports nothing — see the note there.
// Re-exported so a server module can keep importing everything from this one file.
export {
  DEFAULT_FOLLOW_MODE,
  FOLLOW_MODES,
  type FollowMode,
...
import { FOLLOW_MODES } from './follow-modes'
