  ...
  return (
    <div
      className={cn(
        ...
        light ? 'bg-white shadow-[inset_0_0_0_1px_#dedbe8]' : 'bg-surface-2',
      )}
    >
      <Bar className="h-[3px] w-2.5 rounded-[1px] bg-brand-hover opacity-80" />
      <Bar className={cn('h-0.5 w-2', light ? 'bg-[#cfcbdc]' : 'bg-surface-3')} />
      <Bar className={cn('h-0.5 w-2', light ? 'bg-[#cfcbdc]' : 'bg-surface-3')} />
      <Bar
        className={cn(
          'ml-auto h-[3px] w-3.5 rounded-[2px]',
          light ? 'bg-[#cfcbdc]' : 'bg-surface-3',
        )}
      />
    </div>
  )
      ...
      {Array.from({ length: n }, (_, i) => (
        <span
          ...
          className={cn(
            'rounded-[2px]',
            light
              ? 'bg-white shadow-[0_1px_2px_rgba(20,16,40,.1),inset_0_0_0_1px_#e2dfea]'
              : 'bg-surface-3',
          )}
        />
      ))}
...
export function LayoutThumb({ direction }: { direction: Direction }) {
  switch (direction) {
    case 'A':
      return (
        <div className="flex h-[100px] w-[150px] flex-col gap-[5px] rounded-md bg-surface-1 p-2 shadow-[inset_0_0_0_1px_rgba(255,255,255,.06)]">
          <Header />
    ...
    case 'B':
      return (
        <div className="flex h-[100px] w-[150px] flex-col gap-[5px] rounded-md bg-surface-1 p-2 shadow-[inset_0_0_0_1px_rgba(255,255,255,.06)]">
          <Header />
          <div className="flex flex-1 gap-[5px]">
            <div className="relative w-[62px] shrink-0 rounded-[4px] bg-[linear-gradient(160deg,var(--color-surface-3),var(--color-surface-2))] shadow-[inset_0_0_0_1px_rgba(255,255,255,.06)]">
            ...
            <div className="grid min-w-0 flex-1 grid-cols-2 grid-rows-2 gap-1">
              {[0, 1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="flex flex-col gap-[3px] rounded-[3px] bg-surface-2 p-[3px] shadow-[inset_0_0_0_1px_rgba(255,255,255,.06)]"
                >
                  <Bar className="flex-1 rounded-[2px] bg-surface-3" />
    ...
    case 'C':
      return (
        <div className="flex h-[100px] w-[150px] gap-2 rounded-md bg-black p-2.5 shadow-[inset_0_0_0_1px_rgba(255,255,255,.06)]">
          ...
          <div className="h-[66px] w-11 shrink-0 self-center rounded-[2px] bg-[linear-gradient(180deg,var(--color-surface-3),var(--color-surface-2))] shadow-[inset_0_0_0_1px_rgba(255,255,255,.08)]" />
        </div>
      )
    case 'D':
      return (
    ...
    case 'E':
      return (
        <div className="flex h-[100px] w-[150px] flex-col gap-[5px] rounded-md bg-[#eeecf3] p-2 shadow-[inset_0_0_0_1px_rgba(255,255,255,.06)]">
          <Header light />
          <div className="flex flex-1 gap-[5px]">
            <div className="flex min-w-0 flex-1 flex-col gap-[5px]">
              <div className="h-7 rounded-[4px] bg-white shadow-[0_1px_2px_rgba(20,16,40,.1),inset_0_0_0_1px_#e2dfea]" />
              <Cards n={4} cols={4} light />
            </div>
            <div className="flex w-[30px] shrink-0 flex-col gap-[3px] rounded-[3px] bg-white p-1 shadow-[0_1px_2px_rgba(20,16,40,.1),inset_0_0_0_1px_#e2dfea]">
              <Bar className="h-[3px] bg-[#dedbe8]" />
              <Bar className="h-[3px] w-4/5 bg-[#dedbe8]" />
              <Bar className="h-[3px] bg-[#dedbe8]" />
              <Bar className="flex-1 rounded-[2px] bg-[#eeecf3]" />
            </div>
          </div>
        </div>
      )
    default:
      return (
        <div className="flex h-[100px] w-[150px] flex-col gap-1.5 overflow-hidden rounded-md bg-bg-deep shadow-[inset_0_0_0_1px_rgba(255,255,255,.06)]">
