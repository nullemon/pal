...
export function Spoiler({ children }: { children: ReactNode }) {
  ...
  return (
    <button
      ...
      className="inline-flex h-5 items-center gap-1.5 rounded-full border border-line bg-surface-2 px-2 align-[-5px] text-[12px] font-semibold text-fg-muted [text-shadow:0_0_6px_var(--color-fg-muted)] hover:border-brand hover:text-fg"
    >
