...
export const adminMessages = {
  ...
  /**
  /** Appearance -> Brand (docs/15 "Brand and identity"). */
  brand: {
    title: 'Brand and identity',
    subtitle:
      'The name, the mark and the images the site wears. Everything here reaches the header, the footer, the browser tab, the share cards and the installed app.',
    saved: 'Brand saved',
    identity: 'Identity',
    identityHint: 'Also used for page titles, emails and the installed app name.',
    siteName: 'Site name',
    tagline: 'Tagline',
    taglineHint: 'One line under the footer wordmark, and the default page description.',
    wordmark: 'Wordmark style',
    wordmarkHint:
      'What the header and footer show. With no logo uploaded the built-in mark stands in.',
    wordmarkStyles: {
      logo: 'Logo only',
      'logo+name': 'Logo and name',
      name: 'Name only',
    },
    pick: 'Logo',
    pickHint:
      'Ten directions drawn for this site, shown on the dark ground, on white, and at favicon size. Pick one, or use your own — whichever you choose last is the one the site wears, and an upload is kept either way.',
    selected: 'Selected',
    useMyOwn: 'Use my own',
    useMyOwnHint: 'Falls back to the files uploaded below, then to the built-in mark.',
    uploads: 'Logo and images',
    uploadsHint:
      'SVG is preferred for the logo and the monogram: it stays sharp at every size. PNG, JPEG, WebP and AVIF are re-encoded on upload; SVG is kept as it is and refused if it carries script.',
    slots: {
      logo_dark: 'Logo (dark backgrounds)',
      logo_light: 'Logo (light backgrounds)',
      monogram: 'Monogram',
      social_image: 'Default social image',
    },
    slotHints: {
      logo_dark:
        'Shown in the header and footer. Used in both themes when no light version is uploaded.',
      logo_light: 'Takes over when a reader switches to the light theme.',
      monogram:
        'A square mark, used when no logo above is picked. The favicon and every PWA icon size are generated from it.',
      social_image: '1200x630. Used when a page has no better image of its own.',
    },
    monogramBg: 'Icon background',
    monogramBgHint:
      'The square behind the mark in the Apple and maskable icons, which must be opaque. Pick something the mark contrasts with — most of the logos above are drawn in the accent, so an accent square hides them. Ignored by the ordinary favicon.',
    ...
    removeAsset: 'Remove',
    noAsset: 'Not set',
    tooLarge: 'That file is larger than 2 MB.',
    unsafeSvg: 'That SVG contains script or an event handler, so it was refused.',
    unsupported: 'That is not an image this accepts.',
    preview: 'Preview',
    previewHint: 'The header wordmark as it will render.',
  },

  /** Appearance -> Menus (docs/15 "Header, footer, menus"). */
  menus: {
    title: 'Header, footer, menus',
    subtitle:
      'Every link in the chrome: the header row, the accent button, the footer columns, the community block and the bar above it all.',
    saved: 'Menus saved',
    header: 'Header links',
    headerHint:
      'In order, left to right. "Phone" adds the link to a scrolling row under the header on small screens, where the desktop row is hidden.',
    label: 'Label',
    target: 'Target',
    targetHint: 'A path like /browse, or a full https:// address.',
    prefix: 'Match sub-pages',
    prefixHint: 'Highlight the link on /browse/action as well as /browse.',
    onPhone: 'Phone',
    addLink: 'Add link',
    moveUp: 'Move up',
    moveDown: 'Move down',
    removeRow: 'Remove',
    empty: 'Nothing here. The site will render this part empty.',
    primaryButton: 'Primary button',
    primaryButtonHint: 'The accent-filled control on the right of the header.',
    showButton: 'Show the button',
    footer: 'Footer columns',
    footerHint: 'Up to four. Each becomes a column on desktop and an accordion on a phone.',
    columnTitle: 'Column heading',
    addColumn: 'Add column',
    removeColumn: 'Remove column',
    columnLimit: 'Four columns is the maximum.',
    community: 'Community',
    communityHint: 'Leave one empty to drop its icon from the footer.',
    discord: 'Discord invite',
    rss: 'Show the RSS link',
    rssHint: 'Only appears when feeds are enabled under System -> SEO.',
    support: 'Support links',
    legal: 'Copyright and attribution',
    copyright: 'Copyright line',
    attribution: 'Attribution line',
    attributionHint: 'Optional second line: credits, a translation notice, a hosting note.',
    bottomNav: 'Mobile bottom nav',
    bottomNavHint: 'Choose up to four. They appear in the order you pick them.',
    bottomNavCount: '{n} of 4 chosen',
    announcement: 'Announcement bar',
    announcementHint: 'A strip above the header, on every page of the public site.',
    announcementText: 'Message',
    announcementTextHint:
      'Plain text, plus **bold**, *italic* and [links](/browse). HTML is not accepted and is shown as text.',
    tone: 'Tone',
    tones: { info: 'Info', warning: 'Warning', promo: 'Promo' },
    startsAt: 'Starts',
    endsAt: 'Ends',
    scheduleHint:
      'Local time. Leave either empty for no bound. A change takes up to a minute to appear.',
    audience: 'Audience',
    audiences: { everyone: 'Everyone', guests: 'Signed out only', members: 'Signed in only' },
    audienceHint:
      'Anything but Everyone is applied in the browser, so the bar is hidden until the page has loaded.',
  ...
  /** Admin → Content → Add from AniList: fill a series from a public catalogue. */
  seriesLookup: {
    navLabel: 'Add from AniList',
    title: 'Add from AniList',
    subtitle:
      'Search a public catalogue and create series from what it knows: cover, titles, author, synopsis, genres, status and year.',
    searchLabel: 'Title',
    searchPlaceholder: 'Search by title…',
    search: 'Search',
    searching: 'Searching…',
    noResults: 'Nothing matched that title.',
    prompt: 'Type a title above to find it.',
    selected: '{n} selected',
    addSelected: 'Add {n} as drafts',
    adding: 'Adding…',
    selectAll: 'Select all',
    clearSelection: 'Clear',
    byline: '{people}',
    unknownAuthor: 'Author unknown',
    noSynopsis: 'No synopsis on the source.',
    /** Every import lands as a draft; saying so up front stops a wrong match reaching readers. */
    draftNote:
      'Everything added here is a draft. Check it, add the chapters, then publish when you are ready.',
    createdTitle: 'Added {n} series',
    createdHint: 'Each one is a draft. Open it to check the details and publish.',
    failedTitle: '{n} could not be added',
    unmatchedGenres: 'Genres this site does not have yet: {names}',
    coverPending: 'Cover is being processed',
    coverMissing: 'No cover — add one by hand',
    open: 'Open',
    sourceUnavailable: 'AniList did not answer. Try again in a moment.',
    rateLimited: 'Too many searches. Wait a moment and try again.',
    attribution: 'Metadata from AniList.',
    lookup: 'Look up',
    use: 'Use this',
    dialogTitle: 'Fill from AniList',
    dialogHint:
      'Picking one fills the fields below. Nothing is saved until you press Save changes.',
    close: 'Close',
    applied: 'Fields filled — check them, then save.',
